(function ( $ ) {
	...
	$.fn.BootSideMenu = function( options ) {
		...
		newCode += "	<div class=\"col-12 col-sm-12 col-md-12 col-lg-12\" data-side=\""+side+"\">\n"+ oldCode+" </div>\n";
		newCode += "</div>";
		newCode += "<div class=\"toggler \">\n";
		newCode += "	<i class=\"fa fa-chevron-right text-light \">&nbsp;</i> <i class=\"fa fa-chevron-left text-light \">&nbsp;</i>\n";
		newCode += "</div>\n";
